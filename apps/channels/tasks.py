    ...
    if segments:
        ...
        try:
            ...
            if _ok:
                ...
                # Pre-cleanup DB update: ensure URLs point to the final file
                try:
                    ...
                    if _pre_rmtree_rec:
                        ...
                        # Clear legacy pre-restart paths if they exist
                        _pre_rmtree_cp.pop("_pre_restart_ts_paths", None)
                        _pre_rmtree_cp.pop("interrupted_reason", None)
